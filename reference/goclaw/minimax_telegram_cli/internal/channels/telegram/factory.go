...
// Source: /Users/pineapple/Desktop/OpenClaw_go/goclaw/internal/channels/telegram/factory.go
...
// 这份文件解决的是：
// “数据库里的 channel instance 记录，怎么变成一个真正可运行的 Telegram Channel。”
//
// 所以它的职责不是收消息，也不是发消息，
// 而是“把 JSON 配置 / credentials 解码成 TelegramConfig，再交给 New(...)”。
//
// 你读这份文件时，重点看：
//
// - telegramCreds
// - telegramInstanceConfig
// - Factory / FactoryWithStores
// - buildChannel(...)
//
// 这份文件很关键，因为它把“持久化配置”和“运行时对象”连起来了。
//
import (
	"encoding/json"
	"fmt"
