...
// - 一条回复最终怎么发到 Telegram
// - 回复已有消息还是发新消息
// - forum topic / message thread_id 怎么处理
// - Markdown / HTML / link preview / media 怎么处理
//
// 如果你后面要在 openlaw-go 里自己接 Telegram，
// send.go 往往会比 handlers.go 更先影响“用户感受到的效果”，
// 因为消息发送格式、线程路由、编辑策略都在这里。
//
import (
	"context"
	"errors"
